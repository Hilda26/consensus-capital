...
export function ConsensusLedger({ consensus }: { consensus: ConsensusResult }) {
  return (
    <section className="bg-deep-navy text-ivory-signal rounded-3xl p-8">
      <div className="flex flex-wrap items-end justify-between gap-6">
        <div>
          <div className="text-xs font-data text-pearl-aqua tracking-wider">CONSENSUS LEDGER</div>
          <div className="font-display text-6xl">{Math.round(consensus.consensus_score)}</div>
      ...
      <div className="mt-8 text-sm text-ivory-signal/90">
      ...
      <div className="mt-8 border-t border-pearl-aqua/20 pt-4">
