...
export function ConsensusHero() {
  return (
    <section className="grid md:grid-cols-2 gap-10 items-center">
      <div>
        <h1 className="font-display text-5xl md:text-6xl text-deep-navy leading-tight">
          CONSENSUS<br />CAPITAL
        </h1>
        <p className="mt-4 font-display text-xl text-dusk-blue">
          Many minds. One capital consensus.
        </p>
        <p className="mt-6 text-deep-navy/80 max-w-md">
